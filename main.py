...
# Importamos tu renderer actualizado
...
async def render_video(
    ...
    try:
        # 1. Guardar Video Principal
        with open(temp_video_path, "wb") as buffer:
            shutil.copyfileobj(video.file, buffer)
            
        # 2. Guardar Logos (Si existen)
        ...
        # 4. Preparar Configuración (Con rutas absolutas)
        config = {
            "main_bg": main_bg,
            "info_bg": info_bg,
            ...
            "show_liga": show_liga,
            # Pasamos las rutas absolutas de las imágenes guardadas
